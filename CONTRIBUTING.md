...
| Thanh Lam Le | Tech Leader | GitHub repo setup, KNN + K-Means++ search |
...
| Vo Ngoc Gia Bao | QA / Reviewer | Validating each stage (folder structure, data pipeline, model/metrics, final end-to-end QA), testing, presentation |
